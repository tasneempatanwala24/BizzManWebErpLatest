...
function BindBranchDropdown() {
    ...
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/BranchMasterList',
        data: JSON.stringify({
            "EmpId": $('#ContentPlaceHolder1_loginuser').val()
        }),
...
function BindEmployeeDropdown() {
    ...
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/EmployeesMasterList',
        data: JSON.stringify({
            "id": $('#ContentPlaceHolder1_loginuser').val()
        }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            beforeSend: function () {
            ...
            success: function (response) {
                ...
                $('#ddlEmployee').val(JSON.parse(response.d)[0].EmpId);
                FetchEmployeeDetails($('#ddlEmployee').val());
                
                $("#ddlYear").val((new Date).getFullYear());
                if ($("#ddlEmployee").val() == '' || $("#ddlEmployee").val() == null) {
                    $('#lblmsg').append('You are not registered as an employee');
                    $('#lblmsg').show();
                }
                else {
...
function FetchEmployeeDetails(empid) {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/FetchEmployeeDetails',
        data: JSON.stringify({
            "EmpId": empid
        }),
        contentType: "application/json; charset=utf-8",
...
function BindYearDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/YearList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function BindMonthDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/MonthList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function ClearAll() {
    ...
    $('#btnDisplayData').hide();
    BindEmployeeDropdown();
    //BindBranchDropdown($('#ddlEmployee').val());
}
function CreateData() {
    $('#divDataList').hide();
...
function BindEmpLeaveList() {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/FetchEmpLeaveList',
        data: JSON.stringify({
            "empId": $('#ContentPlaceHolder1_loginuser').val()
        }),
        contentType: "application/json; charset=utf-8",
        ...
        success: function (response) {
            ...
            for (var i = 0; i < JSON.parse(response.d).length; i++) {
                ...
                html = html + '<tr><td>' + data[i].LeaveApplicationId + '</td>'
...
function FetchLeaveDetailList(LeaveApplicationId) {
    ...
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/FetchEmpLeaveDataDetails',
        data: JSON.stringify({
...
function DeleteLeaveDetailData(Id, LeaveApplicationId) {
    ...
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/DeleteLeaveDetailData',
        data: JSON.stringify({
            "Id": Id,
            "LeaveApplicationId": LeaveApplicationId
        }),
...
function AddData() {
    ...
    if ($('#ddlBranch').val() == '') {
        ...
        alertify.error("Cannot create, invalid employee Id");
        isValid = false;
    }
    else if ($('#Year').val() == '') {
        alertify.error("Please select Year");
    ...
    if (isValid) {
        ...
        $.ajax({
            type: "POST",
            url: 'wfHrEmpLeaveApplicationIndivisual.aspx/CheckDataAvailability',
            ...
            success: function (response) {
                ...
                if (data == 'False') {
                    $.ajax({
                        type: "POST",
                        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/AddData',
                        data: JSON.stringify({
...
function FetchEmpLeaveDetails(LeaveApplicationId) {
    ...
    $.ajax({
        type: "POST",
        url: 'wfHrEmpLeaveApplicationIndivisual.aspx/FetchEmpLeaveDetails',
        data: JSON.stringify({
            "LeaveApplicationId": LeaveApplicationId
        }),
        contentType: "application/json; charset=utf-8",
...
function showAllImages() {
    ...
    $(".kanban-img").each(function (item) {
        $.ajax({
            type: "POST",
            url: 'wfHrEmpLeaveApplicationIndivisual.aspx/GetEmpImageById',
            data: JSON.stringify({

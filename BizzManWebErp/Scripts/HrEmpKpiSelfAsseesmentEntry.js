...
$(document).ready(function () {
    ...
    //$('#ContentPlaceHolder1_loginuser').val()
   // FetchUserDetails($('#ddlEmployee').val());
    FetchUserDetails($('#ContentPlaceHolder1_loginuser').val());
...
function FetchUserDetails(userid) {
    $.ajax({
      ...
      //  url: 'wfHrEmpKpi.aspx/FetchEmployeeDetails',
        url: 'wfHrEmpKpi.aspx/FetchUserDetails',
        data: JSON.stringify({
            "UserId": userid
        }),
...
function BindManaerialAssesmentDropdown() {
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#ddlSelfAssesment').append(abranch);

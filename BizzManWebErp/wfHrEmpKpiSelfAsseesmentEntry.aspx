<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="wfHrEmpKpiSelfAsseesmentEntry.aspx.cs" Inherits="BizzManWebErp.wfHrEmpKpiSelfAsseesmentEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/HrEmpKpiSelfAsseesmentEntry.js"></script>
                    ...
                    <div class="panel-body">
                        <table class="tbl">
                            <tr>
                                ...
                                <td>
                                   <input type="text" class="form-control" id="txtBranch" name="txtBranch" maxlength="200" />
                                </td>
                                <td>
                                    <label class="control-label">Emp Id *</label>
                                </td>
                                <td>
                                    <input type="text" class="form-control" id="txtEmpId" name="txtEmpId" maxlength="200" />
                                </td>
                            </tr>
                            <tr>
                                <td>Emp Name</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="ddlSelfAssesment" name="ddlSelfAssesment" class="form-control" >
                                    </select>
                                </td>

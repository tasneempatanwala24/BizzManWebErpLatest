...
function BindBranchDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpSalaryReportIndivisual.aspx/BranchMasterList',
        data: {},
...
function BindEmployeeDropdown(brnch) {
    ...
    if (chk == 1) {
        $.ajax({
            type: "POST",
            url: 'wfHrEmpSalaryReportIndivisual.aspx/EmployeeMasterList',
            data: JSON.stringify({
                "branchid": branch
            }),
            contentType: "application/json; charset=utf-8",
...
function FetchEmployeeDetails(empid) {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpSalaryReportIndivisual.aspx/FetchEmployeeDetails',
        data: JSON.stringify({
            "EmpId": empid
        }),
        contentType: "application/json; charset=utf-8",
...
function BindEmployeeSaleryApproveList(tbodyid, tbl_id, branchid, month, year, empid, SalaryType, SalaryApprove) {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpSalaryReportIndivisual.aspx/FetchEmployeSalaryApproveList',
        data: JSON.stringify({
            "branchid": branchid,
            "month": month,
            "year": year,
                ...
                $('#btnExportPDF').click(function (event) {
                    ...
                    table.$('input[type="checkbox"]').each(function () {
                        ...
                        if (this.checked) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: 'wfHrEmpSalaryReportIndivisual.aspx/SalaryExportToPDF',
                                data: JSON.stringify({
                                    "id": id
                                }),
                                contentType: "application/json; charset=utf-8",
...
function RejectSalaryApprove(id) {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpSalaryReportIndivisual.aspx/RejectSalaryApprove',
        data: JSON.stringify({
            "id": id,
...
function UpdateSalaryApprove(id) {
    $.ajax({
        type: "POST",
        url: 'wfHrEmpSalaryReportIndivisual.aspx/UpdateSalaryApprove',
        data: JSON.stringify({
            "id": id,
            "loginuser": $('#ContentPlaceHolder1_loginuser').val()
        }),
...
function PrintPreview(Id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'wfHrEmpSalaryReportIndivisual.aspx/GetPdfContent',
        contentType: 'application/json; charset=utf-8',
        data: JSON.stringify({
            "Id": Id
        }),

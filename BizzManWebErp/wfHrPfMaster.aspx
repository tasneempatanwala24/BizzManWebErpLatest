<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="wfHrPfMaster.aspx.cs" Inherits="BizzManWebErp.wfHrPfMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="lblPFMaster" runat="server" class = "badge rounded-pill bg-light text-dark" style="margin-left:13px;font-size:15px;" Text="PF Master"></asp:Label>
                    ...
                    <div class="container">
                            ...
                            <asp:GridView ID="GridView1" class="table table-bordered table-condensed table-responsive table-hover " runat="server" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="grdData_PageIndexChanging">
                                <Columns>
                                    ...
                                    <asp:boundfield DataField="FixEmployerContribution" HeaderText="Fix Employer Contribution"></asp:boundfield>
                                    <asp:boundfield DataField="AdminCharges" HeaderText="Admin Charges"></asp:boundfield>
                                    <asp:boundfield DataField="EDLI" HeaderText="EDLI"></asp:boundfield>

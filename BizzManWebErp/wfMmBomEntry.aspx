<%@ Page Title="" Language="C#" MasterPageFile="~/MmMainMenu.Master" AutoEventWireup="true" CodeBehind="wfMmBomEntry.aspx.cs" Inherits="BizzManWebErp.wfMmBomEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/MmBomEntry.js"></script>
</asp:Content>
        ...
        <table id="tblMaterialBOMList" class="display">
            <thead>
                <tr>
                    ...
                    <th style="white-space: nowrap;display:none;">BOM Id</th>
                    <th style="white-space: nowrap;">Material Name</th>
                    <th style="white-space: nowrap;">Qty</th>
                    <th style="white-space: nowrap;">Unit Measure</th>
                    <th style="white-space: nowrap;">Manufacturing Type</th>
                    <th style="white-space: nowrap;">Bom Type</th>
                    <th style="white-space: nowrap;">Shop Floor</th>
                </tr>
            </thead>

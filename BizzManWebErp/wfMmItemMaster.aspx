<%@ Page Title="" Language="C#" MasterPageFile="~/MmMainMenu.Master" AutoEventWireup="true" CodeBehind="wfMmItemMaster.aspx.cs" Inherits="BizzManWebErp.wfMmItemMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/MmItemMaster.js"></script>
                            ...
                            <tr>
                                <td style="width: 15%;">Costing Method</td>
                                    <td>
                                      ...
                                      <td>
                                        <label class="control-label">Sales Unit Measure*</label>
                                    </td>
                                    <td>

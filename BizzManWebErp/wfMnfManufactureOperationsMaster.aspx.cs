...
{
    public partial class wfMnfManufactureOperationsMaster : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string OperationIdList()
        {
           // clsMain objMain = new clsMain();
            ...
            try
            {
               ...
               // dtBranchList = objMain.dtFetchData("select Id, KpiGroupName FROM tblHrEmpKpiGroupMaster");
                dtBranchList = objMain.dtFetchData("select OperationsCategoryId, OperationsCategoryId FROM tblMnfManufactureOperationsCategory");
            }
            catch (Exception ex)
            {
                return "";
            ...
            try
            {
             //   dtMaterialList = objMain.dtFetchData(@"select a.Id, a.KpiGroupId, b.KpiGroupName, a.KpiSubGroupName 
              ...
              //                     where a.KpiGroupId=b.Id and a.Id = " + Id + "");
                ...
                dtMaterialList = objMain.dtFetchData(@"select Id,OperationsCategoryId,OperationsName,UnitMesureName,QTY,TimeRequire,TimeRequireUnit,OperationCost
                                   from tblMnfManufactureOperationsMaster
                                   where Id = " + Id + "");
         ...
         //   clsMain objMain = new clsMain();
            ...
            try
            {
               ...
               //                                  from tblHrEmpKpiSubGroupMaster a, tblHrEmpKpiGroupMaster b
                ...
                dtEmpList = objMain.dtFetchData(@"select Id,OperationsCategoryId,OperationsName,UnitMesureName,QTY,TimeRequire,TimeRequireUnit,OperationCost
                                                 from tblMnfManufactureOperationsMaster ");
            }
            catch (Exception ex)
            {

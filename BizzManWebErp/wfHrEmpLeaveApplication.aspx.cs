...
{
    public partial class wfHrEmpLeaveApplication : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string FetchEmpLeaveList()
        {
            DataTable dtList = new DataTable();
            ...
            string Month, string LeaveStatus, string emp_leave_details, string PhotoImage, string Description="",string LoginUser = "")
        {
            ...
            var resultstatus = objMain.ExecuteProcedure("procHrEmpLeaveApplication", objParam);
            string json = JsonConvert.SerializeObject(resultstatus, Formatting.None);
            return json;
        }
    }

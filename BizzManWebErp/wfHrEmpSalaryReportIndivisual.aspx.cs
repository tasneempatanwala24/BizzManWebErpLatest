...
{
    public partial class wfHrEmpSalaryReportIndivisual : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string FetchEmployeSalaryApproveList(string branchid = "", string month = "", string year = "", string EmployeeId = "", string SalaryType = "", string SalaryApprove = "",string id = "")
        {
            // clsMain objMain = new clsMain();
            ...
            try
            {
                ...
                dtEmpSalaryGenerateList = objMain.dtFetchData(@" select sg.*,e.EmpName  from tblHrPayrollMonthlySalaryGenerate sg, tblHrEmpMaster e
                                                        inner join tblUserMaster u on e.empId=u.empid
                                                        where e.EmpId=sg.EmpId 
                                                       and  e.PresentStatus='Working' and e.Active='Y'
                                                        and sg.SalaryPayment='N' and u.Username='" + id + "'"

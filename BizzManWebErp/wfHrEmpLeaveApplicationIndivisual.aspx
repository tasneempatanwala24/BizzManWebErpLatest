<%@ Page Title="Employee Leave" Language="C#" MasterPageFile="~/ExternalPage.Master" AutoEventWireup="true" CodeBehind="wfHrEmpLeaveApplicationIndivisual.aspx.cs" Inherits="BizzManWebErp.wfHrEmpLeaveApplicationIndivisual" %>
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/wfHrEmpLeaveApplicationIndivisual.js"></script>
    <style>
            .table.dataTable {
                ...
                <div class="panel panel-default">   
                    <div class="panel-body">
                        <table class="tbl">
                          <tr>
                              <td colspan="3">
                                  <label id="lblmsg" style="display: none;color:red;"/>
                              </td>
                              </tr>
                            <tr>
                                <td style="width:15%">

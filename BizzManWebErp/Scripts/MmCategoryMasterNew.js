...
function BindParentCategoryDropdown(categoryid) {
    $.ajax({
        type: "POST",
        url: 'wfMmCategoryMasterNew.aspx/BindParentCategoryList',
        data: JSON.stringify({
...
function BindCategoryTypeDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfMmCategoryMasterNew.aspx/BindCategoryTypeDropdown',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function BindAccountDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfMmCategoryMasterNew.aspx/BindAccountDropdown',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function BindCategoryList() {
    $.ajax({
        type: "POST",
        url: 'wfMmCategoryMasterNew.aspx/FetchCategoryList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function CheckCategoryNameAvailability() {
    $.ajax({
        type: "POST",
        url: 'wfMmCategoryMasterNew.aspx/CheckCategoryNameAvailability',
        ...
        if ($('#ddlInventoryValuation').val() != '') {
            if ($('#ddlIncomeAccount').val() != '') {
                if ($('#ddlExpenseAccount').val() != '') {
                    $.ajax({
                        type: "POST",
                        url: 'wfMmCategoryMasterNew.aspx/AddCategory',
                        data: JSON.stringify({
...
function FetchEmployeeDetails(name) {
    $.ajax({
        type: "POST",
        url: 'wfMmCategoryMasterNew.aspx/FetchCategoryDetails',
        data: JSON.stringify({
            "Name": name
        }),
        contentType: "application/json; charset=utf-8",

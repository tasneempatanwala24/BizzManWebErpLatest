...
function BindShopFlowerDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfMmBomEntry.aspx/ShopFlowerList',
        data: {},
...
function BindUnitMeasureDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfMmBomEntry.aspx/UnitMeasureList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function FetchBOMDetailsMaterials() {
    ...
    if ($('#ddlMaterial').val() != '') {
        $.ajax({
            type: "POST",
            url: 'wfMmBomEntry.aspx/DetailMaterialMasterList',
            data: JSON.stringify({
...
function BindMaterialMasterDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfMmBomEntry.aspx/MaterialMasterList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function BindMaterialBOMMasterList() {
    $.ajax({
        type: "POST",
        url: 'wfMmBomEntry.aspx/FetchMaterialBOMMasterList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function DownloadFile() {
    ...
    if (BOMid != '') {
        $.ajax({
            type: "POST",
            url: "wfMmBomEntry.aspx/FetchMaterialBOMMasterListDownload",
            data: JSON.stringify({
                "BOMid": BOMid
            }),
            contentType: "application/json; charset=utf-8",
...
function FetchMaterialBOMMasterDetails(id) {
    $.ajax({
        type: "POST",
        url: 'wfMmBomEntry.aspx/FetchMaterialBOMMasterDetails',
        data: JSON.stringify({
            "BOMId": id
        }),
        contentType: "application/json; charset=utf-8",
...
function ShowHideMaterialRows() {
    if ($('#txtFormula').val().trim() != '') {
        $.ajax({
            type: "POST",
            url: 'wfMmBomEntry.aspx/CheckFormulaAlreadyExist',
            data: JSON.stringify({
                    ...
                    if ($("input:radio[name='optradioBomType']:checked").val() != undefined) {
                        if ($('#ddlShopFlower').val() != '') {
                            ...
                            if (indent_details != '') {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: 'wfMmBomEntry.aspx/AddMaterialBOMMaster',
                                    data: JSON.stringify({
                                        "MaterialId": $('#ddlMaterial').val(),
                                        "Qty": $('#txtQty').val(),
...
function FetchBOMDetailsList(type,bomid) {
    ...
    if (type == 2) {
        ...
        $.ajax({
            type: "POST",
            url: 'wfMmBomEntry.aspx/FetchBOMDetailsList',
            data: JSON.stringify({
                "BOMId": BOM_id,
...
function UpdateBOMFormula() {
    if ($('#txtFormulaName').val() != '') {
        ...
        if (indent_details != '') {
            ...
            $.ajax({
                type: "POST",
                url: 'wfMmBomEntry.aspx/UpdateMaterialBOMFormulaDetails',
                data: JSON.stringify({
                    "BOMId": $('#ddlFormula').val(),
...
function FetchBOMDetailsMaterialsModal(BOMId) {
    $('#ddlMaterialNameModal').html('<option value="">-Select Material Name-</option>');
        $.ajax({
            type: "POST",
            url: 'wfMmBomEntry.aspx/DetailMaterialMasterListModal',
            data: JSON.stringify({
                "BOMId": BOMId
            }),
            contentType: "application/json; charset=utf-8",
...
function DeleteBOMFormula() {
    alertify.confirm('Confirm Formula Delete', 'Are you sure, you want to delete this formula?', function () {
        $.ajax({
            type: "POST",
            url: 'wfMmBomEntry.aspx/BOMFormulaDelete',
            data: JSON.stringify({
                "BOMId": $('#ddlFormula').val(),
                "Formula": $("#ddlFormula option:selected").text()
            }),

...
function ClearAll() {
    $('#ddlMaterialCategoryName,#ddlCategoryName,#ddlSubCategory,#ddlMaterialGroup,#ddlDepartment,#txtId,#txtRelationPurchaseUnitMesure,#txtMaterialName,#ddlUnitMesure,#txtMrp,#txtBarcode,#txtDescription,#txtHsnNo').val('');
    $('#txtMaterialName').removeAttr('readonly');
    $('#ddlMaterialType').val('');
    $('#ddlBranch').val('');
    $('#ddlNatureOfItem').val('Good');
                ...
                if (data == 'False') {
                    $.ajax({
                        ...
                        data: JSON.stringify({
                            ...
                            "NatureOfItem": isEmpty($('#ddlNatureOfItem').val()) ? "Good" : $('#ddlNatureOfItem').val().trim(),

...
function BindCrmCustomerMasterDetails() {
    $.ajax({
        type: "POST",
        url: 'wfAdminCompanyMaster.aspx/GetCustomerList',
        data: {},
...
function FetchCRMCustomerMaster(CustomerId) {
    $.ajax({
        type: "POST",
        url: 'wfAdminCompanyMaster.aspx/GetCustomerById',
        data: JSON.stringify({
            "Id": CustomerId
        }),
        contentType: "application/json; charset=utf-8",
...
function AddDetails() {
    ...
    if (isValid) {
        ...
        $.ajax({
            ...
            type: "POST",
            processData: false,
            url: 'wfAdminCompanyMaster.aspx/AddCustomer',
...
function fillCountry() {
    $.ajax({
        type: "POST",
        url: 'wfAdminCompanyMaster.aspx/CountryList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function fillState() {
    $.ajax({
        type: "POST",
        url: 'wfAdminCompanyMaster.aspx/StateList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function fillStateByCountry(country, state) {
    ...
    $.ajax({
        type: "POST",
        url: 'wfAdminCompanyMaster.aspx/StateListByCountry',
...
function fillBranch() {
    $.ajax({
        type: "POST",
        url: 'wfAdminCompanyMaster.aspx/BranchList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function fillCityAutoComplete(state) {
    ...
    $.ajax({
        type: "POST",
        url: "wfAdminCompanyMaster.aspx/CityListByState",
...
function fillCity(state, city) {
    ...
    $.ajax({
        type: "POST",
        url: 'wfAdminCompanyMaster.aspx/CityList',
        data: JSON.stringify({ "stateId": state }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function showAllImages() {
    ...
    $(".kanban-img").each(function (item) {
        ...
        $.ajax({
            type: "POST",
            url: 'wfAdminCompanyMaster.aspx/GetCustomerImageById',
            data: JSON.stringify({
                "Id": $(this).attr('title')
            }),
            contentType: "application/json; charset=utf-8",
...
function Title() {
    window.location = "wfAdminCompanyMaster.aspx";
}
